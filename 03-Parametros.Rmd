...
```{r sutva-meme, echo=FALSE, out.width="60%", fig.align="center", fig.cap="Cuando asumes SUTVA pero hay efectos de derrame (spillovers)"}
knitr::include_graphics("img/sutva_meme.png")
```
