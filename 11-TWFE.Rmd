...
| `did2s` (Gardner) | La primera etapa modela correctamente el resultado no tratado y sostiene tendencias paralelas | Observaciones no tratadas usadas para estimar la primera etapa | *Leads*, placebos y gráficas de residuos de la primera etapa | La segunda etapa no elimina sesgo por una primera etapa mal especificada |
