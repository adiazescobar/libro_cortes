...
La elección de $V$ orienta la búsqueda de $W$. En implementaciones habituales, $V$ se selecciona para que los pesos resultantes reproduzcan bien el resultado durante periodos pretratamiento reservados o mediante una optimización anidada. Por ello, un predictor con gran peso en $V$ puede ser decisivo para construir $W$, pero no es una unidad donante; y una unidad con gran peso en $W$ no es necesariamente la más parecida en cada predictor por separado.
