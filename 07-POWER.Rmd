...
```{r belmont-audio, echo=FALSE, results='asis'}
cat('::: {.boxaudio}\n\n**\U0001F3A7 Escucha antes de la clase &mdash; *The Three Pillars of Human Experimentation***\n\n*Resumen del Informe Belmont (1979): los tres principios \U00E9ticos que rigen cualquier experimento con seres humanos.*\n\n<audio controls><source src="audio/The_Three_Pillars_of_Human_Experimentation.m4a" type="audio/mp4">Tu navegador no soporta el reproductor de audio.</audio>\n\n:::\n')
```
