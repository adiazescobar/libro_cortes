...
<!-- preamble start -->
    ...
    <script>
      ...
      const tableFns_zafb36xq5coe9lwx19ka = TinyTable.createTableFunctions("tinytable_zafb36xq5coe9lwx19ka");
      // tinytable span after
      window.addEventListener('load', function () {
          var cellsToStyle = [
            // tinytable style arrays after
          { positions: [ { i: '10', j: 2 }, { i: '10', j: 3 }, { i: '10', j: 4 }, { i: '10', j: 5 } ], css_id: 'tinytable_css_r7yrqp2kctvhz00hj72u',}, 
          { positions: [ { i: '8', j: 2 }, { i: '8', j: 3 }, { i: '8', j: 4 }, { i: '8', j: 5 } ], css_id: 'tinytable_css_akmj5wu2lewyzlbwrtcx',}, 
          { positions: [ { i: '1', j: 2 }, { i: '2', j: 2 }, { i: '3', j: 2 }, { i: '4', j: 2 }, { i: '5', j: 2 }, { i: '6', j: 2 }, { i: '7', j: 2 }, { i: '9', j: 2 }, { i: '1', j: 3 }, { i: '2', j: 3 }, { i: '3', j: 3 }, { i: '4', j: 3 }, { i: '5', j: 3 }, { i: '6', j: 3 }, { i: '7', j: 3 }, { i: '9', j: 3 }, { i: '1', j: 4 }, { i: '2', j: 4 }, { i: '3', j: 4 }, { i: '4', j: 4 }, { i: '5', j: 4 }, { i: '6', j: 4 }, { i: '7', j: 4 }, { i: '9', j: 4 }, { i: '1', j: 5 }, { i: '2', j: 5 }, { i: '3', j: 5 }, { i: '4', j: 5 }, { i: '5', j: 5 }, { i: '6', j: 5 }, { i: '7', j: 5 }, { i: '9', j: 5 } ], css_id: 'tinytable_css_qx7siwdw6rzvzspmjhmw',}, 
          { positions: [ { i: '0', j: 2 }, { i: '0', j: 3 }, { i: '0', j: 4 }, { i: '0', j: 5 } ], css_id: 'tinytable_css_zdwl5mjujypc3arsjsem',}, 
          { positions: [ { i: '10', j: 1 } ], css_id: 'tinytable_css_ul206v3qar74c0vny97w',}, 
          { positions: [ { i: '8', j: 1 } ], css_id: 'tinytable_css_l51u971xoxiaome7xi9d',}, 
          { positions: [ { i: '1', j: 1 }, { i: '2', j: 1 }, { i: '3', j: 1 }, { i: '4', j: 1 }, { i: '5', j: 1 }, { i: '6', j: 1 }, { i: '7', j: 1 }, { i: '9', j: 1 } ], css_id: 'tinytable_css_fts4yetixr9z2wex9b2g',}, 
          { positions: [ { i: '0', j: 1 } ], css_id: 'tinytable_css_fi8zgubuunja1l3blemt',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  tableFns_zafb36xq5coe9lwx19ka.styleCell(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
...
<!-- preamble start -->
    ...
    <script>
      // Create table-specific functions using external factory
      const tableFns_xjgpp2brs08bnxhgkpgp = TinyTable.createTableFunctions("tinytable_xjgpp2brs08bnxhgkpgp");
      // tinytable span after
      window.addEventListener('load', function () {
          var cellsToStyle = [
            // tinytable style arrays after
          { positions: [ { i: '14', j: 2 }, { i: '14', j: 3 } ], css_id: 'tinytable_css_pi7c4sqoq7jivbplli3n',}, 
          { positions: [ { i: '12', j: 2 }, { i: '12', j: 3 } ], css_id: 'tinytable_css_uvwr6npqlzv6g0bb611c',}, 
          { positions: [ { i: '1', j: 2 }, { i: '2', j: 2 }, { i: '3', j: 2 }, { i: '4', j: 2 }, { i: '5', j: 2 }, { i: '6', j: 2 }, { i: '7', j: 2 }, { i: '8', j: 2 }, { i: '9', j: 2 }, { i: '10', j: 2 }, { i: '11', j: 2 }, { i: '13', j: 2 }, { i: '1', j: 3 }, { i: '2', j: 3 }, { i: '3', j: 3 }, { i: '4', j: 3 }, { i: '5', j: 3 }, { i: '6', j: 3 }, { i: '7', j: 3 }, { i: '8', j: 3 }, { i: '9', j: 3 }, { i: '10', j: 3 }, { i: '11', j: 3 }, { i: '13', j: 3 } ], css_id: 'tinytable_css_mr1h3zsbi4as36ip6rue',}, 
          { positions: [ { i: '0', j: 2 }, { i: '0', j: 3 } ], css_id: 'tinytable_css_7fdbrfddlns0rhcxgy81',}, 
          { positions: [ { i: '14', j: 1 } ], css_id: 'tinytable_css_i1f88ejmftxrziisafhs',}, 
          { positions: [ { i: '12', j: 1 } ], css_id: 'tinytable_css_t34frpxus67xu3lsnix5',}, 
          { positions: [ { i: '1', j: 1 }, { i: '2', j: 1 }, { i: '3', j: 1 }, { i: '4', j: 1 }, { i: '5', j: 1 }, { i: '6', j: 1 }, { i: '7', j: 1 }, { i: '8', j: 1 }, { i: '9', j: 1 }, { i: '10', j: 1 }, { i: '11', j: 1 }, { i: '13', j: 1 } ], css_id: 'tinytable_css_r85zmp8mg67hq86vxu78',}, 
          { positions: [ { i: '0', j: 1 } ], css_id: 'tinytable_css_23xd3rqbdi0rck5iv7p6',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  tableFns_xjgpp2brs08bnxhgkpgp.styleCell(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
    ...
    <style>
    /* tinytable css entries after */
    #tinytable_xjgpp2brs08bnxhgkpgp td.tinytable_css_pi7c4sqoq7jivbplli3n, #tinytable_xjgpp2brs08bnxhgkpgp th.tinytable_css_pi7c4sqoq7jivbplli3n {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.08em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_xjgpp2brs08bnxhgkpgp td.tinytable_css_uvwr6npqlzv6g0bb611c, #tinytable_xjgpp2brs08bnxhgkpgp th.tinytable_css_uvwr6npqlzv6g0bb611c {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_xjgpp2brs08bnxhgkpgp td.tinytable_css_mr1h3zsbi4as36ip6rue, #tinytable_xjgpp2brs08bnxhgkpgp th.tinytable_css_mr1h3zsbi4as36ip6rue { text-align: center }
    #tinytable_xjgpp2brs08bnxhgkpgp td.tinytable_css_7fdbrfddlns0rhcxgy81, #tinytable_xjgpp2brs08bnxhgkpgp th.tinytable_css_7fdbrfddlns0rhcxgy81 {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 1; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.08em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_xjgpp2brs08bnxhgkpgp td.tinytable_css_i1f88ejmftxrziisafhs, #tinytable_xjgpp2brs08bnxhgkpgp th.tinytable_css_i1f88ejmftxrziisafhs {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.08em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    #tinytable_xjgpp2brs08bnxhgkpgp td.tinytable_css_t34frpxus67xu3lsnix5, #tinytable_xjgpp2brs08bnxhgkpgp th.tinytable_css_t34frpxus67xu3lsnix5 {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    #tinytable_xjgpp2brs08bnxhgkpgp td.tinytable_css_r85zmp8mg67hq86vxu78, #tinytable_xjgpp2brs08bnxhgkpgp th.tinytable_css_r85zmp8mg67hq86vxu78 { text-align: left }
    #tinytable_xjgpp2brs08bnxhgkpgp td.tinytable_css_23xd3rqbdi0rck5iv7p6, #tinytable_xjgpp2brs08bnxhgkpgp th.tinytable_css_23xd3rqbdi0rck5iv7p6 {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 1; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.08em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    </style>
    <div class="container">
      <table class="tinytable" id="tinytable_xjgpp2brs08bnxhgkpgp" style="width: auto; margin-left: auto; margin-right: auto;" data-quarto-disable-processing='true'>
