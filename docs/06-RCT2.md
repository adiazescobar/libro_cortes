...
<!-- preamble start -->
    ...
    <script>
      ...
      const tableFns_iypbwg0dyo31qr2l2eda = TinyTable.createTableFunctions("tinytable_iypbwg0dyo31qr2l2eda");
      // tinytable span after
      window.addEventListener('load', function () {
          var cellsToStyle = [
            // tinytable style arrays after
          { positions: [ { i: '10', j: 2 }, { i: '10', j: 3 }, { i: '10', j: 4 }, { i: '10', j: 5 } ], css_id: 'tinytable_css_2lir9jpc8ruj7s813sxv',}, 
          { positions: [ { i: '8', j: 2 }, { i: '8', j: 3 }, { i: '8', j: 4 }, { i: '8', j: 5 } ], css_id: 'tinytable_css_b9fh39bc0kdi6f70qh9x',}, 
          { positions: [ { i: '1', j: 2 }, { i: '2', j: 2 }, { i: '3', j: 2 }, { i: '4', j: 2 }, { i: '5', j: 2 }, { i: '6', j: 2 }, { i: '7', j: 2 }, { i: '9', j: 2 }, { i: '1', j: 3 }, { i: '2', j: 3 }, { i: '3', j: 3 }, { i: '4', j: 3 }, { i: '5', j: 3 }, { i: '6', j: 3 }, { i: '7', j: 3 }, { i: '9', j: 3 }, { i: '1', j: 4 }, { i: '2', j: 4 }, { i: '3', j: 4 }, { i: '4', j: 4 }, { i: '5', j: 4 }, { i: '6', j: 4 }, { i: '7', j: 4 }, { i: '9', j: 4 }, { i: '1', j: 5 }, { i: '2', j: 5 }, { i: '3', j: 5 }, { i: '4', j: 5 }, { i: '5', j: 5 }, { i: '6', j: 5 }, { i: '7', j: 5 }, { i: '9', j: 5 } ], css_id: 'tinytable_css_si8rqyu5sxxc4hn00svx',}, 
          { positions: [ { i: '0', j: 2 }, { i: '0', j: 3 }, { i: '0', j: 4 }, { i: '0', j: 5 } ], css_id: 'tinytable_css_1phg5vct7gso47l9dl1c',}, 
          { positions: [ { i: '10', j: 1 } ], css_id: 'tinytable_css_quund4ju0myw6dnrom2c',}, 
          { positions: [ { i: '8', j: 1 } ], css_id: 'tinytable_css_kk9f3tjatackuntkz0i1',}, 
          { positions: [ { i: '1', j: 1 }, { i: '2', j: 1 }, { i: '3', j: 1 }, { i: '4', j: 1 }, { i: '5', j: 1 }, { i: '6', j: 1 }, { i: '7', j: 1 }, { i: '9', j: 1 } ], css_id: 'tinytable_css_fqp5wpje2evuhrqsnmrm',}, 
          { positions: [ { i: '0', j: 1 } ], css_id: 'tinytable_css_jf8k6awc42cat69i1y0c',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  tableFns_iypbwg0dyo31qr2l2eda.styleCell(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
...
<!-- preamble start -->
    ...
    <script>
      // Create table-specific functions using external factory
      const tableFns_hzdeclyk2aijmol4qf06 = TinyTable.createTableFunctions("tinytable_hzdeclyk2aijmol4qf06");
      // tinytable span after
      window.addEventListener('load', function () {
          var cellsToStyle = [
            // tinytable style arrays after
          { positions: [ { i: '14', j: 2 }, { i: '14', j: 3 } ], css_id: 'tinytable_css_m1e3pcu8o7tv2q9zse7k',}, 
          { positions: [ { i: '12', j: 2 }, { i: '12', j: 3 } ], css_id: 'tinytable_css_i636mrkq67zdrzunhwo2',}, 
          { positions: [ { i: '1', j: 2 }, { i: '2', j: 2 }, { i: '3', j: 2 }, { i: '4', j: 2 }, { i: '5', j: 2 }, { i: '6', j: 2 }, { i: '7', j: 2 }, { i: '8', j: 2 }, { i: '9', j: 2 }, { i: '10', j: 2 }, { i: '11', j: 2 }, { i: '13', j: 2 }, { i: '1', j: 3 }, { i: '2', j: 3 }, { i: '3', j: 3 }, { i: '4', j: 3 }, { i: '5', j: 3 }, { i: '6', j: 3 }, { i: '7', j: 3 }, { i: '8', j: 3 }, { i: '9', j: 3 }, { i: '10', j: 3 }, { i: '11', j: 3 }, { i: '13', j: 3 } ], css_id: 'tinytable_css_tslir6x1sz31toap70p1',}, 
          { positions: [ { i: '0', j: 2 }, { i: '0', j: 3 } ], css_id: 'tinytable_css_762iybmjp47l52vvw68a',}, 
          { positions: [ { i: '14', j: 1 } ], css_id: 'tinytable_css_euae2zt0clv2oaokwpm5',}, 
          { positions: [ { i: '12', j: 1 } ], css_id: 'tinytable_css_xas2wocd8banyc05kgt2',}, 
          { positions: [ { i: '1', j: 1 }, { i: '2', j: 1 }, { i: '3', j: 1 }, { i: '4', j: 1 }, { i: '5', j: 1 }, { i: '6', j: 1 }, { i: '7', j: 1 }, { i: '8', j: 1 }, { i: '9', j: 1 }, { i: '10', j: 1 }, { i: '11', j: 1 }, { i: '13', j: 1 } ], css_id: 'tinytable_css_1c75mo164jtu88uuhc33',}, 
          { positions: [ { i: '0', j: 1 } ], css_id: 'tinytable_css_w86fvpu578xzht270z6g',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  tableFns_hzdeclyk2aijmol4qf06.styleCell(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
    ...
    <style>
    /* tinytable css entries after */
    #tinytable_hzdeclyk2aijmol4qf06 td.tinytable_css_m1e3pcu8o7tv2q9zse7k, #tinytable_hzdeclyk2aijmol4qf06 th.tinytable_css_m1e3pcu8o7tv2q9zse7k {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.08em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_hzdeclyk2aijmol4qf06 td.tinytable_css_i636mrkq67zdrzunhwo2, #tinytable_hzdeclyk2aijmol4qf06 th.tinytable_css_i636mrkq67zdrzunhwo2 {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_hzdeclyk2aijmol4qf06 td.tinytable_css_tslir6x1sz31toap70p1, #tinytable_hzdeclyk2aijmol4qf06 th.tinytable_css_tslir6x1sz31toap70p1 { text-align: center }
    #tinytable_hzdeclyk2aijmol4qf06 td.tinytable_css_762iybmjp47l52vvw68a, #tinytable_hzdeclyk2aijmol4qf06 th.tinytable_css_762iybmjp47l52vvw68a {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 1; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.08em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_hzdeclyk2aijmol4qf06 td.tinytable_css_euae2zt0clv2oaokwpm5, #tinytable_hzdeclyk2aijmol4qf06 th.tinytable_css_euae2zt0clv2oaokwpm5 {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.08em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    #tinytable_hzdeclyk2aijmol4qf06 td.tinytable_css_xas2wocd8banyc05kgt2, #tinytable_hzdeclyk2aijmol4qf06 th.tinytable_css_xas2wocd8banyc05kgt2 {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    #tinytable_hzdeclyk2aijmol4qf06 td.tinytable_css_1c75mo164jtu88uuhc33, #tinytable_hzdeclyk2aijmol4qf06 th.tinytable_css_1c75mo164jtu88uuhc33 { text-align: left }
    #tinytable_hzdeclyk2aijmol4qf06 td.tinytable_css_w86fvpu578xzht270z6g, #tinytable_hzdeclyk2aijmol4qf06 th.tinytable_css_w86fvpu578xzht270z6g {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 1; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.08em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    </style>
    <div class="container">
      <table class="tinytable" id="tinytable_hzdeclyk2aijmol4qf06" style="width: auto; margin-left: auto; margin-right: auto;" data-quarto-disable-processing='true'>
