...
<!-- preamble start -->
    ...
    <script>
      ...
      const tableFns_zaba4aewu28uraiikemf = TinyTable.createTableFunctions("tinytable_zaba4aewu28uraiikemf");
      // tinytable span after
      window.addEventListener('load', function () {
          var cellsToStyle = [
            // tinytable style arrays after
          { positions: [ { i: '10', j: 2 }, { i: '10', j: 3 }, { i: '10', j: 4 }, { i: '10', j: 5 } ], css_id: 'tinytable_css_5ztv9o0e8p94icsrmi6d',}, 
          { positions: [ { i: '8', j: 2 }, { i: '8', j: 3 }, { i: '8', j: 4 }, { i: '8', j: 5 } ], css_id: 'tinytable_css_umwij2c5i0qa4csg0msa',}, 
          { positions: [ { i: '1', j: 2 }, { i: '2', j: 2 }, { i: '3', j: 2 }, { i: '4', j: 2 }, { i: '5', j: 2 }, { i: '6', j: 2 }, { i: '7', j: 2 }, { i: '9', j: 2 }, { i: '1', j: 3 }, { i: '2', j: 3 }, { i: '3', j: 3 }, { i: '4', j: 3 }, { i: '5', j: 3 }, { i: '6', j: 3 }, { i: '7', j: 3 }, { i: '9', j: 3 }, { i: '1', j: 4 }, { i: '2', j: 4 }, { i: '3', j: 4 }, { i: '4', j: 4 }, { i: '5', j: 4 }, { i: '6', j: 4 }, { i: '7', j: 4 }, { i: '9', j: 4 }, { i: '1', j: 5 }, { i: '2', j: 5 }, { i: '3', j: 5 }, { i: '4', j: 5 }, { i: '5', j: 5 }, { i: '6', j: 5 }, { i: '7', j: 5 }, { i: '9', j: 5 } ], css_id: 'tinytable_css_5xe66w6dh9ljvhpaege4',}, 
          { positions: [ { i: '0', j: 2 }, { i: '0', j: 3 }, { i: '0', j: 4 }, { i: '0', j: 5 } ], css_id: 'tinytable_css_g12bry95pcnaywtfb8pk',}, 
          { positions: [ { i: '10', j: 1 } ], css_id: 'tinytable_css_fovypczfem004zjmqlhx',}, 
          { positions: [ { i: '8', j: 1 } ], css_id: 'tinytable_css_epcelv4ttlezsd9ltvn7',}, 
          { positions: [ { i: '1', j: 1 }, { i: '2', j: 1 }, { i: '3', j: 1 }, { i: '4', j: 1 }, { i: '5', j: 1 }, { i: '6', j: 1 }, { i: '7', j: 1 }, { i: '9', j: 1 } ], css_id: 'tinytable_css_38hvgn95m81jbok2t289',}, 
          { positions: [ { i: '0', j: 1 } ], css_id: 'tinytable_css_rvuftyx7bf0l6gozfr0c',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  tableFns_zaba4aewu28uraiikemf.styleCell(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
...
<!-- preamble start -->
    ...
    <script>
      // Create table-specific functions using external factory
      const tableFns_pfutu3wdcmccjxb269fo = TinyTable.createTableFunctions("tinytable_pfutu3wdcmccjxb269fo");
      // tinytable span after
      window.addEventListener('load', function () {
          var cellsToStyle = [
            // tinytable style arrays after
          { positions: [ { i: '14', j: 2 }, { i: '14', j: 3 } ], css_id: 'tinytable_css_vl270itrs32lc7cjx7jh',}, 
          { positions: [ { i: '12', j: 2 }, { i: '12', j: 3 } ], css_id: 'tinytable_css_tfrmfza7iwnx324dmfns',}, 
          { positions: [ { i: '1', j: 2 }, { i: '2', j: 2 }, { i: '3', j: 2 }, { i: '4', j: 2 }, { i: '5', j: 2 }, { i: '6', j: 2 }, { i: '7', j: 2 }, { i: '8', j: 2 }, { i: '9', j: 2 }, { i: '10', j: 2 }, { i: '11', j: 2 }, { i: '13', j: 2 }, { i: '1', j: 3 }, { i: '2', j: 3 }, { i: '3', j: 3 }, { i: '4', j: 3 }, { i: '5', j: 3 }, { i: '6', j: 3 }, { i: '7', j: 3 }, { i: '8', j: 3 }, { i: '9', j: 3 }, { i: '10', j: 3 }, { i: '11', j: 3 }, { i: '13', j: 3 } ], css_id: 'tinytable_css_hz7877xnfhok0b5ipd2m',}, 
          { positions: [ { i: '0', j: 2 }, { i: '0', j: 3 } ], css_id: 'tinytable_css_raqo9rod4dkvglaobrzt',}, 
          { positions: [ { i: '14', j: 1 } ], css_id: 'tinytable_css_vigi4etk8b1skg9d3m4y',}, 
          { positions: [ { i: '12', j: 1 } ], css_id: 'tinytable_css_4cmxznzygey6xn9qb2bh',}, 
          { positions: [ { i: '1', j: 1 }, { i: '2', j: 1 }, { i: '3', j: 1 }, { i: '4', j: 1 }, { i: '5', j: 1 }, { i: '6', j: 1 }, { i: '7', j: 1 }, { i: '8', j: 1 }, { i: '9', j: 1 }, { i: '10', j: 1 }, { i: '11', j: 1 }, { i: '13', j: 1 } ], css_id: 'tinytable_css_8r8koca4sokz8kx5ghs6',}, 
          { positions: [ { i: '0', j: 1 } ], css_id: 'tinytable_css_zj1k9j4zr8pcfwg389d0',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  tableFns_pfutu3wdcmccjxb269fo.styleCell(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
    ...
    <style>
    /* tinytable css entries after */
    #tinytable_pfutu3wdcmccjxb269fo td.tinytable_css_vl270itrs32lc7cjx7jh, #tinytable_pfutu3wdcmccjxb269fo th.tinytable_css_vl270itrs32lc7cjx7jh {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.08em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_pfutu3wdcmccjxb269fo td.tinytable_css_tfrmfza7iwnx324dmfns, #tinytable_pfutu3wdcmccjxb269fo th.tinytable_css_tfrmfza7iwnx324dmfns {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_pfutu3wdcmccjxb269fo td.tinytable_css_hz7877xnfhok0b5ipd2m, #tinytable_pfutu3wdcmccjxb269fo th.tinytable_css_hz7877xnfhok0b5ipd2m { text-align: center }
    #tinytable_pfutu3wdcmccjxb269fo td.tinytable_css_raqo9rod4dkvglaobrzt, #tinytable_pfutu3wdcmccjxb269fo th.tinytable_css_raqo9rod4dkvglaobrzt {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 1; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.08em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_pfutu3wdcmccjxb269fo td.tinytable_css_vigi4etk8b1skg9d3m4y, #tinytable_pfutu3wdcmccjxb269fo th.tinytable_css_vigi4etk8b1skg9d3m4y {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.08em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    #tinytable_pfutu3wdcmccjxb269fo td.tinytable_css_4cmxznzygey6xn9qb2bh, #tinytable_pfutu3wdcmccjxb269fo th.tinytable_css_4cmxznzygey6xn9qb2bh {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    #tinytable_pfutu3wdcmccjxb269fo td.tinytable_css_8r8koca4sokz8kx5ghs6, #tinytable_pfutu3wdcmccjxb269fo th.tinytable_css_8r8koca4sokz8kx5ghs6 { text-align: left }
    #tinytable_pfutu3wdcmccjxb269fo td.tinytable_css_zj1k9j4zr8pcfwg389d0, #tinytable_pfutu3wdcmccjxb269fo th.tinytable_css_zj1k9j4zr8pcfwg389d0 {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 1; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.08em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    </style>
    <div class="container">
      <table class="tinytable" id="tinytable_pfutu3wdcmccjxb269fo" style="width: auto; margin-left: auto; margin-right: auto;" data-quarto-disable-processing='true'>
