...
<!-- preamble start -->
    ...
    <script>
      ...
      const tableFns_7riyljklxz32hzoqyt3a = TinyTable.createTableFunctions("tinytable_7riyljklxz32hzoqyt3a");
      // tinytable span after
      window.addEventListener('load', function () {
          var cellsToStyle = [
            // tinytable style arrays after
          { positions: [ { i: '10', j: 2 }, { i: '10', j: 3 }, { i: '10', j: 4 }, { i: '10', j: 5 } ], css_id: 'tinytable_css_ejpqg24wjz9fudnpyw1s',}, 
          { positions: [ { i: '8', j: 2 }, { i: '8', j: 3 }, { i: '8', j: 4 }, { i: '8', j: 5 } ], css_id: 'tinytable_css_lzvo0ycdv7k7lt6yk9dh',}, 
          { positions: [ { i: '1', j: 2 }, { i: '2', j: 2 }, { i: '3', j: 2 }, { i: '4', j: 2 }, { i: '5', j: 2 }, { i: '6', j: 2 }, { i: '7', j: 2 }, { i: '9', j: 2 }, { i: '1', j: 3 }, { i: '2', j: 3 }, { i: '3', j: 3 }, { i: '4', j: 3 }, { i: '5', j: 3 }, { i: '6', j: 3 }, { i: '7', j: 3 }, { i: '9', j: 3 }, { i: '1', j: 4 }, { i: '2', j: 4 }, { i: '3', j: 4 }, { i: '4', j: 4 }, { i: '5', j: 4 }, { i: '6', j: 4 }, { i: '7', j: 4 }, { i: '9', j: 4 }, { i: '1', j: 5 }, { i: '2', j: 5 }, { i: '3', j: 5 }, { i: '4', j: 5 }, { i: '5', j: 5 }, { i: '6', j: 5 }, { i: '7', j: 5 }, { i: '9', j: 5 } ], css_id: 'tinytable_css_1ob3yi04oz5jei1q9no9',}, 
          { positions: [ { i: '0', j: 2 }, { i: '0', j: 3 }, { i: '0', j: 4 }, { i: '0', j: 5 } ], css_id: 'tinytable_css_2fqi70wd9q1na8orhk8m',}, 
          { positions: [ { i: '10', j: 1 } ], css_id: 'tinytable_css_4piaxy3lcexvwvs7x1k9',}, 
          { positions: [ { i: '8', j: 1 } ], css_id: 'tinytable_css_8envsu6pw8ymjzepve70',}, 
          { positions: [ { i: '1', j: 1 }, { i: '2', j: 1 }, { i: '3', j: 1 }, { i: '4', j: 1 }, { i: '5', j: 1 }, { i: '6', j: 1 }, { i: '7', j: 1 }, { i: '9', j: 1 } ], css_id: 'tinytable_css_vh7je7iazfpl4okm0s9e',}, 
          { positions: [ { i: '0', j: 1 } ], css_id: 'tinytable_css_yrepgdo4n2krw4v3j6m9',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  tableFns_7riyljklxz32hzoqyt3a.styleCell(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
...
<!-- preamble start -->
    ...
    <script>
      // Create table-specific functions using external factory
      const tableFns_ox83mqf9j5vhdn8f6fxn = TinyTable.createTableFunctions("tinytable_ox83mqf9j5vhdn8f6fxn");
      // tinytable span after
      window.addEventListener('load', function () {
          var cellsToStyle = [
            // tinytable style arrays after
          { positions: [ { i: '14', j: 2 }, { i: '14', j: 3 } ], css_id: 'tinytable_css_bk6xvp7ac690pxe5gmak',}, 
          { positions: [ { i: '12', j: 2 }, { i: '12', j: 3 } ], css_id: 'tinytable_css_k67as7mlvsr582uplbmp',}, 
          { positions: [ { i: '1', j: 2 }, { i: '2', j: 2 }, { i: '3', j: 2 }, { i: '4', j: 2 }, { i: '5', j: 2 }, { i: '6', j: 2 }, { i: '7', j: 2 }, { i: '8', j: 2 }, { i: '9', j: 2 }, { i: '10', j: 2 }, { i: '11', j: 2 }, { i: '13', j: 2 }, { i: '1', j: 3 }, { i: '2', j: 3 }, { i: '3', j: 3 }, { i: '4', j: 3 }, { i: '5', j: 3 }, { i: '6', j: 3 }, { i: '7', j: 3 }, { i: '8', j: 3 }, { i: '9', j: 3 }, { i: '10', j: 3 }, { i: '11', j: 3 }, { i: '13', j: 3 } ], css_id: 'tinytable_css_dwcxtqmud4md40f4u800',}, 
          { positions: [ { i: '0', j: 2 }, { i: '0', j: 3 } ], css_id: 'tinytable_css_a6yyo7r83ecqso6b7mv7',}, 
          { positions: [ { i: '14', j: 1 } ], css_id: 'tinytable_css_090zqon8amlwzqquw58a',}, 
          { positions: [ { i: '12', j: 1 } ], css_id: 'tinytable_css_kpryxzllo27fggj568o0',}, 
          { positions: [ { i: '1', j: 1 }, { i: '2', j: 1 }, { i: '3', j: 1 }, { i: '4', j: 1 }, { i: '5', j: 1 }, { i: '6', j: 1 }, { i: '7', j: 1 }, { i: '8', j: 1 }, { i: '9', j: 1 }, { i: '10', j: 1 }, { i: '11', j: 1 }, { i: '13', j: 1 } ], css_id: 'tinytable_css_w2hp0ryrulkwg57a9j07',}, 
          { positions: [ { i: '0', j: 1 } ], css_id: 'tinytable_css_20b9e1intn89e039ypdc',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  tableFns_ox83mqf9j5vhdn8f6fxn.styleCell(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
    ...
    <style>
    /* tinytable css entries after */
    #tinytable_ox83mqf9j5vhdn8f6fxn td.tinytable_css_bk6xvp7ac690pxe5gmak, #tinytable_ox83mqf9j5vhdn8f6fxn th.tinytable_css_bk6xvp7ac690pxe5gmak {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.08em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_ox83mqf9j5vhdn8f6fxn td.tinytable_css_k67as7mlvsr582uplbmp, #tinytable_ox83mqf9j5vhdn8f6fxn th.tinytable_css_k67as7mlvsr582uplbmp {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_ox83mqf9j5vhdn8f6fxn td.tinytable_css_dwcxtqmud4md40f4u800, #tinytable_ox83mqf9j5vhdn8f6fxn th.tinytable_css_dwcxtqmud4md40f4u800 { text-align: center }
    #tinytable_ox83mqf9j5vhdn8f6fxn td.tinytable_css_a6yyo7r83ecqso6b7mv7, #tinytable_ox83mqf9j5vhdn8f6fxn th.tinytable_css_a6yyo7r83ecqso6b7mv7 {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 1; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.08em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_ox83mqf9j5vhdn8f6fxn td.tinytable_css_090zqon8amlwzqquw58a, #tinytable_ox83mqf9j5vhdn8f6fxn th.tinytable_css_090zqon8amlwzqquw58a {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.08em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    #tinytable_ox83mqf9j5vhdn8f6fxn td.tinytable_css_kpryxzllo27fggj568o0, #tinytable_ox83mqf9j5vhdn8f6fxn th.tinytable_css_kpryxzllo27fggj568o0 {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    #tinytable_ox83mqf9j5vhdn8f6fxn td.tinytable_css_w2hp0ryrulkwg57a9j07, #tinytable_ox83mqf9j5vhdn8f6fxn th.tinytable_css_w2hp0ryrulkwg57a9j07 { text-align: left }
    #tinytable_ox83mqf9j5vhdn8f6fxn td.tinytable_css_20b9e1intn89e039ypdc, #tinytable_ox83mqf9j5vhdn8f6fxn th.tinytable_css_20b9e1intn89e039ypdc {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 1; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.08em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    </style>
    <div class="container">
      <table class="tinytable" id="tinytable_ox83mqf9j5vhdn8f6fxn" style="width: auto; margin-left: auto; margin-right: auto;" data-quarto-disable-processing='true'>
