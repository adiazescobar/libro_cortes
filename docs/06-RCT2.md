...
<!-- preamble start -->
    ...
    <script>
      ...
      const tableFns_sz68rftmxk0vy01kqyxw = TinyTable.createTableFunctions("tinytable_sz68rftmxk0vy01kqyxw");
      // tinytable span after
      window.addEventListener('load', function () {
          var cellsToStyle = [
            // tinytable style arrays after
          { positions: [ { i: '10', j: 2 }, { i: '10', j: 3 }, { i: '10', j: 4 }, { i: '10', j: 5 } ], css_id: 'tinytable_css_qu6llnkolh4ikzny70a8',}, 
          { positions: [ { i: '8', j: 2 }, { i: '8', j: 3 }, { i: '8', j: 4 }, { i: '8', j: 5 } ], css_id: 'tinytable_css_quucv2a03n01hnt9bryb',}, 
          { positions: [ { i: '1', j: 2 }, { i: '2', j: 2 }, { i: '3', j: 2 }, { i: '4', j: 2 }, { i: '5', j: 2 }, { i: '6', j: 2 }, { i: '7', j: 2 }, { i: '9', j: 2 }, { i: '1', j: 3 }, { i: '2', j: 3 }, { i: '3', j: 3 }, { i: '4', j: 3 }, { i: '5', j: 3 }, { i: '6', j: 3 }, { i: '7', j: 3 }, { i: '9', j: 3 }, { i: '1', j: 4 }, { i: '2', j: 4 }, { i: '3', j: 4 }, { i: '4', j: 4 }, { i: '5', j: 4 }, { i: '6', j: 4 }, { i: '7', j: 4 }, { i: '9', j: 4 }, { i: '1', j: 5 }, { i: '2', j: 5 }, { i: '3', j: 5 }, { i: '4', j: 5 }, { i: '5', j: 5 }, { i: '6', j: 5 }, { i: '7', j: 5 }, { i: '9', j: 5 } ], css_id: 'tinytable_css_y36x023vhsnh824np5cr',}, 
          { positions: [ { i: '0', j: 2 }, { i: '0', j: 3 }, { i: '0', j: 4 }, { i: '0', j: 5 } ], css_id: 'tinytable_css_hrabmirklh9bf2ckwuma',}, 
          { positions: [ { i: '10', j: 1 } ], css_id: 'tinytable_css_jsg1pqekfkxlb5zgvaoe',}, 
          { positions: [ { i: '8', j: 1 } ], css_id: 'tinytable_css_6d4hbzdsd66w5d3w4ivz',}, 
          { positions: [ { i: '1', j: 1 }, { i: '2', j: 1 }, { i: '3', j: 1 }, { i: '4', j: 1 }, { i: '5', j: 1 }, { i: '6', j: 1 }, { i: '7', j: 1 }, { i: '9', j: 1 } ], css_id: 'tinytable_css_i5selawffkobn6dh7nzz',}, 
          { positions: [ { i: '0', j: 1 } ], css_id: 'tinytable_css_o68p0vw0gan5qj4cq38e',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  tableFns_sz68rftmxk0vy01kqyxw.styleCell(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
...
<!-- preamble start -->
    ...
    <script>
      // Create table-specific functions using external factory
      const tableFns_mzjsx243oh30myup724s = TinyTable.createTableFunctions("tinytable_mzjsx243oh30myup724s");
      // tinytable span after
      window.addEventListener('load', function () {
          var cellsToStyle = [
            // tinytable style arrays after
          { positions: [ { i: '14', j: 2 }, { i: '14', j: 3 } ], css_id: 'tinytable_css_993jv85r2029e0sm81cd',}, 
          { positions: [ { i: '12', j: 2 }, { i: '12', j: 3 } ], css_id: 'tinytable_css_th09h48b0l4ma907qz4s',}, 
          { positions: [ { i: '1', j: 2 }, { i: '2', j: 2 }, { i: '3', j: 2 }, { i: '4', j: 2 }, { i: '5', j: 2 }, { i: '6', j: 2 }, { i: '7', j: 2 }, { i: '8', j: 2 }, { i: '9', j: 2 }, { i: '10', j: 2 }, { i: '11', j: 2 }, { i: '13', j: 2 }, { i: '1', j: 3 }, { i: '2', j: 3 }, { i: '3', j: 3 }, { i: '4', j: 3 }, { i: '5', j: 3 }, { i: '6', j: 3 }, { i: '7', j: 3 }, { i: '8', j: 3 }, { i: '9', j: 3 }, { i: '10', j: 3 }, { i: '11', j: 3 }, { i: '13', j: 3 } ], css_id: 'tinytable_css_kkmt5x66dtyouydnqg09',}, 
          { positions: [ { i: '0', j: 2 }, { i: '0', j: 3 } ], css_id: 'tinytable_css_zd6hydloa4x0xxe8tlep',}, 
          { positions: [ { i: '14', j: 1 } ], css_id: 'tinytable_css_waypgosylmnuvv8o9kdw',}, 
          { positions: [ { i: '12', j: 1 } ], css_id: 'tinytable_css_x45cznxpwvrv3fo2yiqb',}, 
          { positions: [ { i: '1', j: 1 }, { i: '2', j: 1 }, { i: '3', j: 1 }, { i: '4', j: 1 }, { i: '5', j: 1 }, { i: '6', j: 1 }, { i: '7', j: 1 }, { i: '8', j: 1 }, { i: '9', j: 1 }, { i: '10', j: 1 }, { i: '11', j: 1 }, { i: '13', j: 1 } ], css_id: 'tinytable_css_14ed356z407zqzs7djfn',}, 
          { positions: [ { i: '0', j: 1 } ], css_id: 'tinytable_css_kihqhm6trefvgz9ppuud',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  tableFns_mzjsx243oh30myup724s.styleCell(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
    ...
    <style>
    /* tinytable css entries after */
    #tinytable_mzjsx243oh30myup724s td.tinytable_css_993jv85r2029e0sm81cd, #tinytable_mzjsx243oh30myup724s th.tinytable_css_993jv85r2029e0sm81cd {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.08em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_mzjsx243oh30myup724s td.tinytable_css_th09h48b0l4ma907qz4s, #tinytable_mzjsx243oh30myup724s th.tinytable_css_th09h48b0l4ma907qz4s {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_mzjsx243oh30myup724s td.tinytable_css_kkmt5x66dtyouydnqg09, #tinytable_mzjsx243oh30myup724s th.tinytable_css_kkmt5x66dtyouydnqg09 { text-align: center }
    #tinytable_mzjsx243oh30myup724s td.tinytable_css_zd6hydloa4x0xxe8tlep, #tinytable_mzjsx243oh30myup724s th.tinytable_css_zd6hydloa4x0xxe8tlep {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 1; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.08em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: center }
    #tinytable_mzjsx243oh30myup724s td.tinytable_css_waypgosylmnuvv8o9kdw, #tinytable_mzjsx243oh30myup724s th.tinytable_css_waypgosylmnuvv8o9kdw {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.08em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    #tinytable_mzjsx243oh30myup724s td.tinytable_css_x45cznxpwvrv3fo2yiqb, #tinytable_mzjsx243oh30myup724s th.tinytable_css_x45cznxpwvrv3fo2yiqb {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 0; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.1em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    #tinytable_mzjsx243oh30myup724s td.tinytable_css_14ed356z407zqzs7djfn, #tinytable_mzjsx243oh30myup724s th.tinytable_css_14ed356z407zqzs7djfn { text-align: left }
    #tinytable_mzjsx243oh30myup724s td.tinytable_css_kihqhm6trefvgz9ppuud, #tinytable_mzjsx243oh30myup724s th.tinytable_css_kihqhm6trefvgz9ppuud {  position: relative; --border-bottom: 1; --border-left: 0; --border-right: 0; --border-top: 1; --line-color-bottom: var(--tt-line-color); --line-color-left: var(--tt-line-color); --line-color-right: var(--tt-line-color); --line-color-top: var(--tt-line-color); --line-width-bottom: 0.05em; --line-width-left: 0.1em; --line-width-right: 0.1em; --line-width-top: 0.08em; --trim-bottom-left: 0%; --trim-bottom-right: 0%; --trim-left-bottom: 0%; --trim-left-top: 0%; --trim-right-bottom: 0%; --trim-right-top: 0%; --trim-top-left: 0%; --trim-top-right: 0%; ; text-align: left }
    </style>
    <div class="container">
      <table class="tinytable" id="tinytable_mzjsx243oh30myup724s" style="width: auto; margin-left: auto; margin-right: auto;" data-quarto-disable-processing='true'>
