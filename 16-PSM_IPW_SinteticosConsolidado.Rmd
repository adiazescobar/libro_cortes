...
cat("```text\n")
cat(sprintf("Mayor diferencia estandarizada cruda:       %.3f\n", max(abs(ipw_bal$smd_raw))))
cat(sprintf("Mayor diferencia estandarizada ponderada:   %.3f\n", max(abs(ipw_bal$smd_weighted))))
cat("Observaciones usadas:                       4,000\n")
cat("```\n")
```
