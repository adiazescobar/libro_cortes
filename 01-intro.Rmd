...
Supongamos que el tratamiento es **ir al hospital** ($D=1$) y que $Y_i(D=d)=1$ significa que la persona se recupera bajo la condición $d$. Los siguientes perfiles son resultados potenciales hipotéticos que ilustran heterogeneidad de efectos; no constituyen recomendaciones clínicas:
