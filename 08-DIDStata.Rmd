...
Todo el capítulo estima un mismo **estimando**: el efecto promedio del tratamiento sobre los tratados (ATT) de un programa de nutrición sobre la talla-para-edad de los niños, identificado con la lógica de diferencias en diferencias del Capítulo \@ref(did-teoria). `base3.dta` contiene **cortes transversales repetidos**: dos grupos (tratados y controles) observados en dos periodos (antes y después), pero sin identificador que permita seguir al mismo niño en el tiempo.
