...
### Etapa 2. Descripción por grupos
...
### Etapa 7. Descomposición del sesgo
...
### Etapa 8. Duplicación de observaciones
...
### Etapa 10. Monte Carlo con selección
...
### Etapa 11. Monte Carlo con aleatorización
...
probabilidad de tratamiento disminuya con `yd0`. Anticipe el signo y el centro
aproximado de NAIVE−ATT, y razone cómo cambiaría su dispersión frente a la regla
canónica. Escriba pseudocódigo Stata ejecutable que modifique `one_rep`, fije una
semilla, ejecute `simulate` y resuma la distribución.
:::
