...
- **ATE:** \(\tau = \mathbb{E}[Y(D=1)-Y(D=0)]\).
- **ATT:** \(\mathbb{E}[Y(D=1)-Y(D=0) \mid D=1]\).
- **ATU:** \(\mathbb{E}[Y(D=1)-Y(D=0) \mid D=0]\).
...
- **Descomposición (sin aleatorización):**
  ...
  \;+\;
  \underbrace{\mathbb{E}[Y(D=0)\mid D=1] - \mathbb{E}[Y(D=0)\mid D=0]}_{\text{sesgo de selección}}.
  \]
