...
Sea $D_i\in\{0,1\}$ la asignación, $Y_i(1)$ y $Y_i(0)$ los resultados potenciales y
...
```{r power-two-distributions, echo=TRUE, fig.cap="Distribuciones del estimador bajo la hipótesis nula y una alternativa; el área sombreada es el poder.", warning=FALSE, message=FALSE}
alpha <- 0.05
se <- 1
delta <- 2.8
