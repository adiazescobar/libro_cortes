...
Cada `summarize` almacenó sus resultados en `r()`. El loop recuperó `r(mean)` y `r(N)` con `post`, una fila a la vez; `postclose` cerró la tabla antes de abrirla y exportarla.
