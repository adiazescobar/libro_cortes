...
`r mcq(c("Hay 95% de probabilidad de que el parámetro verdadero esté en este intervalo específico", answer = "Si construyéramos 100 intervalos de esta manera, 95 de ellos contendrían el parámetro verdadero", "El 95% de los datos está dentro del intervalo", "Estamos 95% seguros de nuestra estimación"))`
